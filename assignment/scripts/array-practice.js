...
let favoriteFoods = ['pizza', 'tacos', 'burgers', 'cookies'];
...
// solved it above by accident first
// 3.b solution: set lastAnimal to index 3 since array is 4 elements
